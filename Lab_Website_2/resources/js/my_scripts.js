...
function loadPlayersPage() {
	...
	for (var i = 0; i < players.length; i++) {
		...
		newTag.href = '#';
		newTag.innerHTML = players[i].name;
		//newTag.onclick = function() { switchPlayers(i); };
		newTag.onclick = func;
		dd.appendChild(newTag);
	}
...
function switchPlayers(playerNum) {
	...
	var a_pass, a_rush, a_rec;

	a_pass = parseInt(parseInt(players[playerNum].pass_yards) / parseInt(players[playerNum].games_played));
	a_rush = parseInt(players[playerNum].rushing_yards) / parseInt(players[playerNum].games_played);
	a_rec = parseInt(players[playerNum].receiving_yards) / parseInt(players[playerNum].games_played);

	document.getElementById('avg_p_yards').innerHTML = a_pass;
	document.getElementById('avg_r_yards').innerHTML = a_rush;
	document.getElementById('avg_rec_yards').innerHTML = a_rec;
